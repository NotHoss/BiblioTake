...
INSERT INTO utente (id, email, username, password, foto_profilo, attivo, ruolo) VALUES
	...
	(102, 'user@gmail.com', 'user', '$2y$10$CMi/jExR0PTN.f4K6TJwkejd3hL4yV03Gkyt/3v7ALhq7rWcHHO7y', 'images/place-holder.jpg', TRUE, 'utente'),
	...
	(104, 'admin@bibliotake.it', 'admin', '$2y$10$JRxG6EJzVeJG3.41PVJGUuF4D7YElYoN9c99XydwmJPCzd2jO3IPm', 'images/place-holder.jpg', TRUE, 'admin'),
	(105, 'anna.neri@gmail.com', 'anna.neri', '$2y$10$V4nK2mP8qR1sT6uY3zX7cE4hJ9mL0oP2rS5tV8wZ1aC4dF7gH6Jk', 'images/place-holder.jpg', TRUE, 'utente'),
	(106, 'paolo.mazza@gmail.com', 'paolo.mazza', '$2y$10$P1qW3eR5tY7uI9oP2aS4dF6gH8jK0lZ2xC4vB6nM8qW1eR3tY5uI', 'images/place-holder.jpg', TRUE, 'utente');
...
INSERT INTO libro (
	...
	(205, '9788807891234', 'Il barone rampante', 'Italo Calvino', 'Mondadori', 11, 2022, 'Italiano', 'Romanzo di formazione e avventura ambientato sugli alberi.', 320, 'images/place-holder.jpg', 'Classici italiani'),
	(206, '9788806228889', 'L ordine del tempo', 'Carlo Rovelli', 'Adelphi', 5, 2021, 'Italiano', 'Saggio divulgativo sul tempo e sulla fisica contemporanea.', 256, 'images/place-holder.jpg', 'Saggistica scientifica'),
	(207, '9781408855652', 'Harry Potter e la pietra filosofale', 'J.K. Rowling', 'Salani', 8, 2023, 'Italiano', 'Primo capitolo della saga del maghetto più famoso.', 336, 'images/place-holder.jpg', 'Fantasy'),
	(208, '9788804685271', 'Se questo è un uomo', 'Primo Levi', 'Einaudi', 14, 2024, 'Italiano', 'Testimonianza fondamentale sulla deportazione nei lager.', 208, 'images/place-holder.jpg', 'Memoria');
